...
class AutofeedController extends Controller
{
    ...
    {
        $data = array();
        $data['jumlah_tbr']         = $_POST['jumlah_tbr'];
        $data['size_bnh']           = $_POST['size_bnh'];
        $data['size_pnn']           = $_POST['size_pnn'];
        $data['lama_plhr']          = $_POST['lama_plhr'];
        $data['tanggal_tbr']        = $_POST['tanggal_tbr'];
        $data['kelangsungan_hdp']   = $_POST['kelangsungan_hdp'];
        $data['FRAwal']             = $_POST['FRAwal'];
        $data['FRAkhir']            = $_POST['FRAkhir'];
